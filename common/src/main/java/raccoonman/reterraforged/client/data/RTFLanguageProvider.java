...
public final class RTFLanguageProvider {
	...
	public static final class EnglishUS extends LanguageProvider {
		...
		protected void addTranslations() {
			...
			this.add(RTFTranslationKeys.GUI_SLIDER_TEMPERATURE_WEIGHT_TARGET, "Weight Target");
			this.add(RTFTranslationKeys.GUI_SLIDER_TEMPERATURE_WEIGHT_STRENGTH, "Weight Strength");
			...
			this.add(RTFTranslationKeys.GUI_SLIDER_MOISTURE_WEIGHT_TARGET, "Weight Target");
			this.add(RTFTranslationKeys.GUI_SLIDER_MOISTURE_WEIGHT_STRENGTH, "Weight Strength");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_TEMPERATURE_WEIGHT_TARGET), "The temperature value to pull generation toward");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_TEMPERATURE_WEIGHT_STRENGTH), "How strongly temperature is pulled toward the target value");
			...
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_MOISTURE_WEIGHT_TARGET), "The moisture value to pull generation toward");
			this.add(Tooltips.translationKey(RTFTranslationKeys.GUI_SLIDER_MOISTURE_WEIGHT_STRENGTH), "How strongly moisture is pulled toward the target value");
